...
<script>
import {getExcavatorGroups, searchExcavator, updateDowntime, getDowntime} from "@/api/excavators";
...
export default { 
    ...
    methods: {
        async loadDowntime() 
        {
            ...
            this.excavatorsList = [data.place_excavator]; 
            ...
            this.downtime = {
                ...
                excavator: data.place_excavator,
            };
        },
        ...
        async saveDowntime()
        {
            const newDowntime = {
                id_place: this.downtime.id_place, 
                id_excavator: this.downtime.id_excavator, 
                id_place_excavator: this.downtime.id_place_excavator, 
