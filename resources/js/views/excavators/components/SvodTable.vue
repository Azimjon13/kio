    ...
    <div class="app-container">
        <el-row :gutter="20">
            <el-col :span="12">
                ...
                <br>
                <div style="text-align: center; font-size: 16px; font-weight: bold;">Объём горной массы</div>
                <el-table
                    :data="plansFacts"
                    fit  highlight-current-row border style="width: 100%;" align="center" 
                >
    ...
    data() {
        return { 
            ...
            downtimesByReasons: [
                ...
                /* {
                    title:"Эксп. вне объёма", 
                    day: this.itogData.downtimes.outScope.dayDowntime,
                    since: this.itogData.downtimes.outScope.sinceDowntime,
                    keyType: 3,
                }, */
                {
                    title: "Отработано экскаваторов",
                    day: Math.round((this.itogData.workHour.day/24)*10)/10,
                    since: Math.round((this.itogData.workHour.since/(24*(new Date(this.date).getDate())))*10)/10,  
                }
            ], 
    ...
    methods: {
        ...
        recalcAfterUpdate(newItogData) 
        {
            ...
            this.downtimesByReasons = [
                ...
                /* {
                    title:"Эксп. вне объёма", 
                    day: newItogData.downtimes.outScope.dayDowntime,
                    since: newItogData.downtimes.outScope.sinceDowntime,
                    keyType: 3,
                }, */
                {
                    title: "Отработано экскаваторов",
                    day: Math.round((newItogData.workHour.day/24)*10)/10,
                    since: Math.round((newItogData.workHour.since/(24*(new Date(this.date).getDate())))*10)/10,  
                }
            ];
        },
