...
<script>
import {getCptGroups, searchCpt, addDowntime} from "@/api/cpts";
...
export default { 
    ...
    methods: {
        ...
        async saveDowntime()
        {
            ...
            const newDowntime = {
                id_place: this.placeId, 
                id_cpt: this.downtime.cpt.id_cpt, 
                id_place_cpt: this.downtime.cpt.id, 
