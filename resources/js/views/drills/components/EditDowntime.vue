...
<script>
import {getDrillGroups, searchDrill, updateDowntime, getDowntime} from "@/api/drills";
...
export default { 
    ...
    methods: {
        async loadDowntime() 
        {
            ...
            this.drillsList = [data.place_drill]; 
        ...
        async saveDowntime()
        {
            const newDowntime = {
                id_place: this.downtime.id_place, 
                id_drill: this.downtime.id_drill, 
                id_place_drill: this.downtime.id_place_drill, 
