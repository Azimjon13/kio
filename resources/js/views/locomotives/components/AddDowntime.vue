...
<script>
import {getLocomotiveGroups, searchLocomotive, addDowntime} from "@/api/locomotives";
...
export default { 
    ...
    methods: {
        ...
        async saveDowntime()
        {
            ...
            const newDowntime = {
                id_place: this.placeId, 
                id_locomotive: this.downtime.locomotive.id_locomotive, 
                id_place_locomotive: this.downtime.locomotive.id, 
