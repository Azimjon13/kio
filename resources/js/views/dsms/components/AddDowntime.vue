...
<script>
import {getDsmGroups, searchDsm, addDowntime} from "@/api/dsms";
...
export default { 
    ...
    methods: {
        ...
        async saveDowntime()
        {
            ...
            const newDowntime = {
                id_place: this.placeId, 
                id_dsm: this.downtime.dsm.id_dsm, 
                id_place_dsm: this.downtime.dsm.id, 
