<template>
    <el-dialog  title="Добавление подразделений" :visible.sync="this.show" width="65%" :before-close="close">
        <div class="form-container">
            <el-form ref="addChildDivisionForm" :model="newDivision" label-position="top" label-width="300px"  style="">
                <el-row :gutter="20">
                    <el-col :span="8">
                        <el-form-item label="Вышестоящее подзразделение/отдел/площадка" label-width="auto">
                            <el-input :value="forParent.full_name_ru" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
